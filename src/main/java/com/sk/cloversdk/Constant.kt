...
object Constant {
    ...
    const val H5_OS_FILE_NAME = "h5os.zip"
    const val SP_NAME = "clover_os_sp"
    const val JS_BRIDGE_INS_CONTENT_DIR = "cloverOSBridge"
    const val OS_BASE_RESOURCE = "QmdSBUbs32ZHHHDe4b7mDK2F9PeKmKyzeZN9VxsQh9i1jP"
};